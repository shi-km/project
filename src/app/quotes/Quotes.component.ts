...
export class QuotesComponent implements OnInit, OnChanges {
  ...
  quotes: Quote[] = [
    new Quote("Cricket civilises people and creates good gentlemen. I want everyone to play cricket in Zimbabwe; I want ours to be a nation of gentlemen.", 'Robert Mugabe', new Date('2019, 02, 12'), 'john', 0, 0),
